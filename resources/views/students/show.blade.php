...
<div class="col-md-12">
    <div class="card">
        ...
        <md-toolbar class="md-primary" md-fixed-header>
            ...
            <md-button class="md-primary" href="{{route('student.edit', $student->id)}}">Редактировать</md-button>
              ...
              <md-card-expand-content>
                <md-card-content>
                    ...
                    @foreach ($records as $info)
                        <li class="list-group-item">Дистанция: {{$info->name}} Время: {{$info->result_time}} Дата выполнения {{$info->result_date}}</li> 
                    @endforeach
                </ul>
                </md-card-content>
              </md-card-expand-content>
